        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rua = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ControllerAction", x => new { x.Controller, x.Metodo, x.Action });
                    table.UniqueConstraint("AK_ControllerAction_ControllerActionID", x => x.ControllerActionID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemoteAddress = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TraceID = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogRequisicoes", x => new { x.Data, x.UsuarioID, x.Metodo, x.Controller, x.Action });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tema = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    DataUltLogin = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Perfil_AspNetUsers_UserAlteracao",
                        column: x => x.UserAlteracao,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Perfil_AspNetUsers_UserCadastro",
                        column: x => x.UserCadastro,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioAvatar", x => x.UsuarioID);
                    table.ForeignKey(
                        name: "FK_UsuarioAvatar_AspNetUsers_UsuarioID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerfilControllerAction", x => new { x.ControllerActionID, x.PerfilID });
                    table.ForeignKey(
                        name: "FK_PerfilControllerAction_ControllerAction_ControllerActionID",
                        column: x => x.ControllerActionID,
                        principalTable: "ControllerAction",
                        principalColumn: "ControllerActionID");
                    table.ForeignKey(
                        name: "FK_PerfilControllerAction_Perfil_PerfilID",
                        column: x => x.PerfilID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Perfil_UserAlteracao",
                table: "Perfil",
                column: "UserAlteracao");

            migrationBuilder.CreateIndex(
                name: "IX_Perfil_UserCadastro",
                table: "Perfil",
                column: "UserCadastro");

            migrationBuilder.CreateIndex(
                name: "IX_PerfilControllerAction_PerfilID",
